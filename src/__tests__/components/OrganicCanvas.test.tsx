...
describe('OrganicCanvas', () => {
  it('renders a canvas element with descriptive aria-label', () => {
    ...
    const canvas = screen.getByLabelText(/Generated organic artwork with/i);
  ...
  it('canvas has correct HiDPI dimensions (width * dpr)', () => {
    ...
    render(<OrganicCanvas scene={minimalScene} animated={false} />);
    const canvas = screen.getByLabelText(/Generated organic artwork with/i) as HTMLCanvasElement;
