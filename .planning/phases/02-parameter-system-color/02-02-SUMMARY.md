...
plan: 02
subsystem: pipeline
tags: [calibration, corpus, distribution-quality, mock-signals, tdd, normalization]

# Dependency graph
requires:
  - phase: 02-parameter-system-color
    provides: Quantile normalization engine (percentileRank, normalizeSignals), TEXT_MAPPINGS, computeParameterVector
provides:
...
tech-stack:
  added: []
  patterns: [calibration-corpus, distribution-quality-gate, version-corpus-coupling, mock-signal-extraction]
...
requirements-completed: [PARAM-03, PARAM-05]
